            ...
            <div className="chat-area">
                ...
                <div className="selected-word">
                    <div className="selected-word-details">
                        <div className='half'>
                            <div className='border element-word'>{(selectedWord.show_kanji || selectedWord.contains_no_kanji && selectedWord.kanji !== selectedWord.hiragana) && selectedWord.kanji}</div>
                    ...
                    <div className="superior-button-wrapper">
                        <button className='button-wrapper' disabled={selectedWord.contains_no_kanji} onClick={toggleKanjiFunction}>Toggle Kanji</button>
